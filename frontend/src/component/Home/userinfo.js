...
export default function MediaCard(user) {
  ...
  let total_male =0
  let data = user.count.map(item =>{
    total_male = item.count + total_male;})
      ...
      <CardActionArea className={classes.data}>
        ...
        <CardContent>
          <Typography gutterBottom variant="h5" component="h5">
              {user.user.username} has been connected {total_male} times
          </Typography>
          <Typography variant="body2" color="textSecondary" component="p">
             {user.user.email}
          </Typography>
          <Typography variant="body2" color="textSecondary" component="p">
             Joined date {user.user.date_joined}
          </Typography>
        </CardContent>
      </CardActionArea>
